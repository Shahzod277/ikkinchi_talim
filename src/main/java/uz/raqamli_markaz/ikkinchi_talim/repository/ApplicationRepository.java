...
public interface ApplicationRepository extends JpaRepository<Application, Integer> {
    ...
    @Query(value = " select a.id id, u.full_name fullName, k.speciality_name speciality,k.edu_form_name eduForm, " +
            ...
            " d.speciality_name diplomaSpeciality ,d.degree_name diplomaDegree,d.diploma_given_date diplomaGivenDate from application a inner join kvota k on k.id = a.kvota_id inner join users u on u.id = a.user_id " +
